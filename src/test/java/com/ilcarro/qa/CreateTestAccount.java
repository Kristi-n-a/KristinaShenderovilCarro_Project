...
public class CreateTestAccount extends TestBase{
        @BeforeMethod
        ...
        public void testSingUp(){
            ...
            wd.findElement(By.cssSelector("#first_name")).sendKeys("KR");

            wd.findElement(By.cssSelector("#second_name")).click();
            wd.findElement(By.cssSelector("#second_name")).clear();
            wd.findElement(By.cssSelector("#second_name")).sendKeys("SH");
